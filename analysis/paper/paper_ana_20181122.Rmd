...
On Nov 22, 2018 a cold front crossed the center of Argentina triggering isolated convective cells (Figure \@ref(fig:case)a) that rapidly grew upscale into an exceptionally large MCS. During that day several surface stations reported lightning, gustfronts and heavy rain. To the north of the region, a warm front contributed to the development of isolated multicells that ultimately grew and merged with the MCS (Figure \@ref(fig:case)c). 
The MCS traveled approximately 2500 km from south to north, dissipating over Paraguay and Southern Brazil after 42 hours. 
 
(ref:case) GOES-16 infrared imagery corresponding to channel 13 (13 mu) for a) 00 UTC, b) 12 UTC Nov 22, and c) 00 UTC Nov 23.
