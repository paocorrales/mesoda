...
Where $P_{oi}$ is the fraction of grid points in the $i-th$ sampling area in which the observed accumulated precipitation is greater than a specified threshold. Following @maldonado2021, $P_{xi}$ is calculated from the ensemble probability precipitation over the same threshold in each grid point by averaging over the $i-th$ sampling area. 
...
A version-controlled repository of the code used to create this analysis, including the code used to download the data can be found at <https://github.com/paocorrales/mesoda>. The derived data that support the findings of this study are also openly available in Zenodo at http://doi.org/[doi], reference number [reference number]. 
