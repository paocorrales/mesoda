\documentclass[authoryear,preprint,review,12pt]{elsarticle} %review=doublespace preprint=single 5p=2 column
...
\begin{frontmatter}
  ...
  \end{abstract}
   \begin{keyword} Regional Data Assimilation, Surface Observations, Satellite Observations\end{keyword}
 \end{frontmatter}
