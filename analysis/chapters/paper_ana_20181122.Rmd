...
All graphics are made using ggplot2 [@wickham2009] and the paper was rendered using knitr and rmarkdown [@xie2015; @allaire2019]. All the experiments were performed at the National Center for Atmospheric Research (NCAR) supercomputer Cheyenne [@Cheyenne2019]. 
