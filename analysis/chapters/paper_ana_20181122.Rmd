...
```{r ciclo, fig.cap="Diagram of analysis cycles between Nov 20th, 18 UTC and Nov 23rd 12 UTC plus and spin up period of 6 hours. The zoomed figure shows assimilation in one-hour centered window and new boundary conditions from GFSD every 6 hours."}
...
files <- Sys.glob("/home/paola.corrales/datosmunin/EXP/derived_data/ppacum/E[2568]_ana*mean_acum_1h.rds")
...
```{r dbz-mean, fig.cap="Figure 14. Observed maximum reflectivity in the column (upper row) and ensemble mean maximum reflectivity for CONV and RAD at different times (bottom two rows)."}
