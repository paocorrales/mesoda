...
```{r dominio, fig.cap="The horizontal domain used on the simulations (black box) and the inner domain used for the validation / evaluation (grey box). The topography in meters is also shown (filled contours).", fig.height=4}
