...
files <- paste0(derived_data, "dbz/maxdbz_ana_E7_", dates, ".nc")
...
dates <- rep(c("20181122100000"), 1, each = 4)
...
dbz %>% 
  ...
  geom_contour_fill(aes(z = max_dbz, fill = stat(level_d)), 
                    proj = norargentina_lambert,
                    breaks = seq(15, 75, 5)) +
  scale_fill_manual(values = ref, drop = FALSE, guide = guide_colorsteps(barwidth = 20, 
                                                                         barheight = 0.8)) +
  
  geom_mapa() +
  facet_wrap(~exp, ncol = 2, labeller = labeller(exp = c(E4 = "CONV", E5 = "AUT", 
                                                         E6 = "SATWND", E7 = "RAD"))) +
...
```{r}
files <- Sys.glob("/home/paola.corrales/mesoda/analysis/data/derived_data/fss_6h_ana_ens_E[4-7].csv")
